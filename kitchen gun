...
local s1 = realchr:FindFirstChild("Accessory (MeshPartAccessory)")
local h1 = api.GetHatInformation(s1)
api.SetHatAlign(h1,chr["Right Arm"],CFrame.new(0,-1.25,-0.25) * CFrame.Angles(math.rad(0),math.rad(90),math.rad(-90)))
