--[[
old star glitcher
used krypton reanimate
hats: noobrig + 5316539421,5316549755,5268602207
by mrcoolperson79
]]
...
--local s1 = realchr:FindFirstChild("Accessory (ShatteredVoidSword)")
--local h1 = api.GetHatInformation(s1)
--api.SetHatAlign(h1,chr["Right Arm"],CFrame.new(0,-1.75,-2) * CFrame.Angles(math.rad(45),0,0))
